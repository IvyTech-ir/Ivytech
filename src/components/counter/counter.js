...
export function Counter() {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement("div", { className: styles.row },
            ...
            React.createElement("button", { className: styles.button, onClick: function () { return dispatch(incrementByAmount(incrementValue)); } }, "Add Amount"),
            React.createElement("button", { className: styles.asyncButton, onClick: function () { return dispatch(incrementAsync(incrementValue)); } }, "Add Async"),
            React.createElement("button", { className: styles.button, onClick: function () { return dispatch(incrementIfOdd(incrementValue)); } }, "Add If Odd"))));
}
