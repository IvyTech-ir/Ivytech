...
export default { Logo: Logo, Undraw_posting_photo: Undraw_posting_photo, Undraw_profile_1: Undraw_profile_1, Undraw_profile_2: Undraw_profile_2, Undraw_profile_3: Undraw_profile_3, Undraw_rocket: Undraw_rocket };
