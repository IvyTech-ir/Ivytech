            ...
            <ul className="navbar-nav ml-auto">
                    ...
                    >
                        ...
                        <a className="dropdown-item d-flex align-items-center" href="#">
                            <div className="dropdown-list-image mr-3">
                                <img className="rounded-circle" src={Images.Undraw_profile_1} alt="..." />
                        ...
                        <a className="dropdown-item d-flex align-items-center" href="#">
                            <div className="dropdown-list-image mr-3">
                                <img className="rounded-circle" src={Images.Undraw_profile_2} alt="..." />
                        ...
                        <a className="dropdown-item d-flex align-items-center" href="#">
                            <div className="dropdown-list-image mr-3">
                                <img className="rounded-circle" src={Images.Undraw_profile_3} alt="..." />
                ...
                <li className="nav-item dropdown no-arrow">
                    <a
                        ...
                        aria-expanded="false"
                    >
                        <span className="mr-2 d-none d-lg-inline text-gray-600 small">{auth?.fullname}</span>
